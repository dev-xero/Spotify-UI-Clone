...
const sidebarHomeComponent = document.querySelector("li#home-component");
const upgradeBtn = document.querySelector("button#get-premium");

let sidebarLinks = appSideBar.querySelectorAll("li.link-s");
let sidebarLinksAnchor = appSideBar.querySelectorAll("li.link-s > a");
const connectivityContainer = document.querySelector(".connectivity-status");
let connectivityStatus = document.querySelector("a#icon-internet");
let connectivityToolTip = document.querySelector(".tool-tip");
let closeConnectivityStatus = document.querySelector("a#close-tooltip");
let displayUsername =appComponent.querySelector("span#username");
...
function checkAccount() {
	...
	let accountUserName = localStorage.getItem("username");
...
sidebarLinks.forEach(function(component) {
...
connectivityStatus.addEventListener("click", (e) => {
	e.preventDefault();
...
closeConnectivityStatus.addEventListener("click", (e) => {
		e.preventDefault();
		connectivityToolTip.classList.remove("visible");
}, false);
